...
<head>
    ...
    <!-- Chart.js (pakai 1 versi terbaru saja) -->
                ...
                <div class="container mx-auto px-6 py-8 mt-8">
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <div class="p-3 mr-4 text-blue-500 bg-blue-100 rounded-full dark:bg-blue-500">
                                <!-- icon -->
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M3 13h2l1 5h12l1-5h2M5 6h14l1 5H4l1-5z" />
                                </svg>
                            </div>
                            <div>
                                <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Pendapatan
                                </p>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">{{ $totalBarang }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            ...
                            <div>
                                <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Keuntungan
                                </p>
